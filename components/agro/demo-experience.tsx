        ...
        <Reveal className="overflow-hidden rounded-[2rem] bg-navy text-navy-foreground shadow-[0_40px_100px_-55px_rgba(7,31,66,.85)]">
          <div className="grid lg:grid-cols-[.72fr_1.28fr]">
            <div className="relative overflow-hidden px-6 py-12 md:px-10 lg:px-12 lg:py-16">
              ...
              <div className="relative"><p className="text-sm font-semibold uppercase tracking-wider text-[#8ed09f]">Demo interactiva</p><h2 className="mt-3 text-balance font-display text-4xl font-bold leading-tight md:text-5xl">Mira cómo se siente usar AgroD.</h2><p className="mt-5 text-lg leading-relaxed text-white/72">Cambia entre las vistas, revisa cultivos y prueba la localización de un equipo. Son datos de ejemplo para enseñar el flujo completo antes de crear una cuenta.</p>
